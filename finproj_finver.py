...
class Homepage:
    ...
    def __init__(self, master):
        ...
        self.l5.grid(row=3, column=6)

        self.l9 = Label(master, text="Price")
        self.l9.grid(row=3, column=4)
        ...
        self.l10.grid(row=4, column=4)

        self.l11 = Label(master, text="$4.99")
        self.l11.grid(row=5, column=4)

        self.l12 = Label(master, text="$4.49")
        self.l12.grid(row=6, column=4)
        ...
        self.sauce_choice.grid(row=7, column=0, columnspan=9)
        ...
        for text, mode, column in self.flavor:
            Radiobutton(master, text=text, variable=self.sauce, value=mode).grid(row=8, column=column)
    ...
    def orderdetail(self):
        ...
        global result
        result = value1 * 3.99 + value2 * 4.99 + value3 * 4.49
        ...
        button_quit.grid(row=8, column=4)
    ...
    def finorder(self):
        if len(e1.get()) == 0 or len(e2.get()) == 0 or len(e3.get()) == 0 or len(e4.get()) == 0:
            ...
            #button to comfirm the final page
